...
class Kafe_GrammarVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by Kafe_GrammarParser#libraryFunctionCall.
    def visitLibraryFunctionCall(self, ctx:Kafe_GrammarParser.LibraryFunctionCallContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by Kafe_GrammarParser#libraryConstant.
    def visitLibraryConstant(self, ctx:Kafe_GrammarParser.LibraryConstantContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by Kafe_GrammarParser#appendCallExpr.
    def visitAppendCallExpr(self, ctx:Kafe_GrammarParser.AppendCallExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by Kafe_GrammarParser#libraryExpr.
    def visitLibraryExpr(self, ctx:Kafe_GrammarParser.LibraryExprContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by Kafe_GrammarParser#removeCallExpr.
    def visitRemoveCallExpr(self, ctx:Kafe_GrammarParser.RemoveCallExprContext):
        return self.visitChildren(ctx)
